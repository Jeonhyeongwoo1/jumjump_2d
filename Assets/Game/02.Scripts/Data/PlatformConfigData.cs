...
namespace JumJump.Data
{
    ...
    public sealed class PlatformConfigData : ScriptableObject
    {
        ...
        public string PlatformShieldSpriteAddressableKey => _platformShieldSpriteAddressableKey;
        public string PlatformRocketSpriteAddressableKey => _platformRocketSpriteAddressableKey;
        ...
        [Header("Platform")]
        [SerializeField] private string _platformNormalSpriteAddressableKey = "Platform.sprite";
        [SerializeField] private string _platformShieldSpriteAddressableKey = "Box_Shield.sprite";
        [SerializeField] private string _platformRocketSpriteAddressableKey = "Box_Rocket.sprite";
        ...
        [SerializeField] private float _platformHeight = 0.58f;
        [SerializeField] private PlatformGimmickSetting[] _platformGimmickSettings =
        {
            ...
            new PlatformGimmickSetting(PlatformGimmickType.Fast, 10, 0.16f, 1f, 1f, 1.105f, 1.105f),
            new PlatformGimmickSetting(PlatformGimmickType.Slow, 10, 0.16f, 1f, 1f, 0.85f, 0.85f),
            new PlatformGimmickSetting(PlatformGimmickType.SmallAndFast, 65, 0.16f, 0.7f, 0.7f, 1.105f, 1.105f),
            new PlatformGimmickSetting(PlatformGimmickType.Ghost, 55, 0.16f, 1f, 1f, 1f, 1f, 0.8f, 1.2f),
            new PlatformGimmickSetting(PlatformGimmickType.Double, 35, 0.1f, 1f, 1f),
            new PlatformGimmickSetting(PlatformGimmickType.Reveal, 45, 0.16f, 1f, 1f, 1f, 1f, 0.08f, 0.18f),
            new PlatformGimmickSetting(PlatformGimmickType.Shield, 0, 1f, 1f, 1f),
            new PlatformGimmickSetting(PlatformGimmickType.Rocket, 0, 1f, 1f, 1f)
        };
