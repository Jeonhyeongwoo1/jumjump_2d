...
namespace JumJump.Data
{
    ...
    public sealed class GameConfigData : ScriptableObject
    {
        ...
        public float BackgroundSkyThemeStartHeight => _backgroundSkyThemeStartHeight;
        public float BackgroundNightThemeStartHeight => _backgroundNightThemeStartHeight;
        public Sprite[] BackgroundGroundSprites => _backgroundGroundSprites;
        public Sprite[] BackgroundSkySprites => _backgroundSkySprites;
        public Sprite[] BackgroundNightSprites => _backgroundNightSprites;
        ...
        [SerializeField] private float _backgroundObjectMinScale = 0.45f;
        [SerializeField] private float _backgroundObjectMaxScale = 0.9f;
        ...
        [SerializeField] private float _backgroundSkyThemeStartHeight = 18f;
        [SerializeField] private float _backgroundNightThemeStartHeight = 52f;
        [SerializeField] private Sprite[] _backgroundGroundSprites;
        [SerializeField] private Sprite[] _backgroundSkySprites;
        [SerializeField] private Sprite[] _backgroundNightSprites;
    }
}
